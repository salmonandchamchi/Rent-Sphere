...
import com.niit.lease.web.app.service.LeaseAgreementService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.niit.lease.web.app.vo.agreement.AgreementDetailVo;
import com.niit.lease.web.app.vo.agreement.AgreementItemVo;
...
public class LeaseAgreementServiceImpl extends ServiceImpl<LeaseAgreementMapper, LeaseAgreement> implements LeaseAgreementService {
    ...
    public AgreementDetailVo getDetailById(Long id) {
        ...
        //4.查询图片信息
        List<GraphVo> roomGraphVoList = graphInfoMapper.selectListByItemTypeAndId(ItemType.APARTMENT, leaseAgreement.getApartmentId());
